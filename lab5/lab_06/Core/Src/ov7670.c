...
//    print_msg(msg);
	...
	for(i=0; i<OV7670_REG_NUM; i++) {
		...
		reg = OV7670_reg[i][0];
		val = OV7670_reg[i][1];
		if (ov7670_write(reg, val) != HAL_OK){
			Error_Handler();
		}
		HAL_Delay(1);
	}
...
uint8_t ov7670_read(uint8_t reg){
	uint8_t data[1];
	if (HAL_I2C_Master_Transmit(&hi2c2,ADDR_OV7670,&reg,1,100) != HAL_OK) {
		Error_Handler();
	}
	if (HAL_I2C_Master_Receive(&hi2c2,ADDR_OV7670,data,1,100) != HAL_OK){
		Error_Handler();
	}
	return data[0];
}
...
HAL_StatusTypeDef ov7670_write(uint8_t reg,uint8_t val){
	...
	data[0] = reg;
	data[1] = val;
	HAL_StatusTypeDef status = HAL_I2C_Master_Transmit(&hi2c2,ADDR_OV7670,data,2,100);
	return status;
}
